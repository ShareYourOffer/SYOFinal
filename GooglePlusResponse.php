...
//    $ApplicationName='syotoday';
    ...
    if ($client->getAccessToken()) {
        ...
        $_SESSION['Details']=array(
            ...
            $LogoutUrl='http://localhost/SYOFinal/GooglePlusResponse.php?XDEBUG_SESSION_START=BA5DFFA0&logout=1',
            $picture=$me['image']['url']
            );

        header('Location: ' . 'http://localhost/SYOFinal/index.php?XDEBUG_SESSION_START=BA5DFFA0', true);
    }
}
